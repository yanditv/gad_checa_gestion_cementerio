...
namespace gad_checa_gestion_cementerio.Migrations
{
    ...
    [Migration("20260818120000_AgregarDifuntoDirectoEnBoveda")]
    partial class AgregarDifuntoDirectoEnBoveda
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("gad_checa_gestion_cementerio.Data.Cementerio", b =>
                {
                    ...
                    b.Property<int>("AniosArriendoNicho")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("VecesRenovacionBovedas")
                        .HasColumnType("int");

                    b.Property<int>("VecesRenovacionNicho")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("gad_checa_gestion_cementerio.Data.Contrato", b =>
                {
                    ...
                    b.Property<int?>("ContratoRelacionadoId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PathDocumentoFirmado")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ContratoRelacionadoId");
            ...
            modelBuilder.Entity("gad_checa_gestion_cementerio.Data.Contrato", b =>
                {
                    ...
                    b.HasOne("gad_checa_gestion_cementerio.Data.Contrato", "ContratoRelacionado")
                        .WithMany()
                        .HasForeignKey("ContratoRelacionadoId");
                    ...
                    b.Navigation("ContratoRelacionado");
